to install, run `npm install discord.js@11.6.4` this will install the dependencys needed, then deleate the discord.js forlder from /node_modules and replace it with this repository.
